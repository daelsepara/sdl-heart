...
public:
    Story179()
    {
        ...
        Choices.clear();
        Choices.push_back(Choice::Base("(Diamond) Reveal Kyle Boche's whereabouts", -179, Codeword::Type::DIAMOND));
