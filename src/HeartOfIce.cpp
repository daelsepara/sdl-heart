...
bool characterScreen(SDL_Window *window, SDL_Renderer *renderer, Character::Base &player, Story::Base *story)
{
    ...
    if (window && renderer)
    {
        ...
        controls.push_back(Button(0, createHeaderButton(window, "Skills", clrWH, intLB, headerw, headerh, text_space), 0, 1, 0, 1, startx, starty + profileh + headerh + marginh, Control::Type::GLOSSARY));
        controls.push_back(Button(1, createHeaderButton(window, "Possessions", clrWH, intLB, headerw, headerh, text_space), 0, 2, 0, 2, startx, starty + profileh + 3 * headerh + 3 * marginh + 2 * boxh, Control::Type::ACTION));
        ...
        if (font)
        {
            while (!done)
            {
                ...
                {
                    putText(renderer, "Codewords", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, headerw, headerh, startx, starty + 2 * profileh + 4 * headerh + 4 * marginh + 2 * boxh);
    ...
    if (Items.size() > 0)
    {
        ...
        while (!done)
        {
            ...
            if (!flash_message)
            {
                ...
                {
                    putText(renderer, "You are carrying too many items. Select item(s) to DROP.", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
                }
                else if (mode == Control::Type::USE)
                {
                    putText(renderer, "Select an item to USE", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
                }
                else if (mode == Control::Type::LOSE)
                {
                    ...
                    putText(renderer, stolen_message.c_str(), font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
                }
                else
                {
                    putText(renderer, "You are carrying these items", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
                }
            }

            putText(renderer, "Life", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, infoh, startx, starty + text_bounds - (boxh + infoh));
            ...
            putText(renderer, "Money", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, infoh, startx, starty + text_bounds - (2 * (boxh + infoh) + box_space));
    ...
    if (TakeLimit > 0)
    {
        ...
        while (!done)
        {
            ...
            if (!error)
            {
                ...
                putText(renderer, take_message.c_str(), font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
            }
            ...
            putText(renderer, "SELECTED", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, infoh, startx, starty + text_bounds - (3 * boxh + infoh));
...
void renderAdventurer(SDL_Window *window, SDL_Renderer *renderer, TTF_Font *font, Character::Base &player)
{
    ...
    putText(renderer, name_string.c_str(), font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, player.Vehicle != Vehicle::Type::NONE ? headerw * 3 : headerw, headerh, startx, starty);
    ...
    putText(renderer, "Skills", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, headerw, headerh, startx, starty + profileh + headerh + marginh);
    ...
    putText(renderer, "Life", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, headerw, headerh, startx, starty + profileh + 2 * headerh + 2 * marginh + boxh);
    ...
    putText(renderer, "Money", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, headerw, headerh, startx + boxw + marginw, starty + profileh + 2 * headerh + 2 * marginh + boxh);
    putText(renderer, (std::to_string(player.Money) + " scads").c_str(), font, text_space, clrBK, intBE, TTF_STYLE_NORMAL, boxw, boxh, startx + boxw + marginw, starty + profileh + 3 * headerh + 2 * marginh + boxh);

    putText(renderer, "Possessions", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, headerw, headerh, startx, starty + profileh + 3 * headerh + 3 * marginh + 2 * boxh);
...
Character::Base customCharacter(SDL_Window *window, SDL_Renderer *renderer)
{
    ...
    if (window && renderer)
    {
        ...
        while (!done)
        {
            ...
            fillRect(renderer, textwidth, text_bounds / 3 - texty, textx, 2 * (texty + text_bounds / 3), intLB);
            ...
            if (current >= 0 && current < Limit)
            {
                ...
                renderText(renderer, text, intLB, textx + text_space, 2 * (texty + text_bounds / 3) + text_space, text_bounds / 3 - texty, 0);
                ...
                else if (controls[current].Type == Control::Type::NEW)
                {
                    if (selection.size() == player.SKILLS_LIMIT)
                    {
                        ...
                        for (auto i = 0; i < selection.size(); i++)
                        {
                            ...
                            if (Skill::ALL[selection[i]].Type == Skill::Type::SHOOTING)
                            {
                                Character::CUSTOM.Items.push_back(Item::BARYSAL_GUN);
                            }
                            else if (Skill::ALL[selection[i]].Type == Skill::Type::ESP || Skill::ALL[selection[i]].Type == Skill::Type::PARADOXING)
                            {
                                if (!Character::VERIFY_ITEMS(Character::CUSTOM, {Item::Type::PSIONIC_FOCUS}))
                                {
                                    Character::CUSTOM.Items.push_back(Item::PSIONIC_FOCUS);
                                }
                            }
                        }
...
bool tradeScreen(SDL_Window *window, SDL_Renderer *renderer, Character::Base &player, Item::Base mine, Item::Base theirs)
{
    ...
    if (Character::VERIFY_ITEMS(player, {mine.Type}))
    {
        ...
        while (!done)
        {
            ...
            if (!error)
            {
                putText(renderer, "TRADE", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
            }
    ...
    if (shop.size() > 0)
    {
        ...
        while (!done)
        {
            ...
            if (!error && !purchased)
            {
                if (mode == Control::Type::BUY)
                {
                    putText(renderer, "Select an item to buy", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
                else
                {
                    putText(renderer, "You may sell your items at prices indicated here", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
            }

            putText(renderer, "Possessions", font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, infoh, startx, starty + text_bounds - (boxh + infoh));
...
Story::Base *processChoices(SDL_Window *window, SDL_Renderer *renderer, Character::Base &player, Story::Base *story)
{
    ...
    if (renderer && story->Choices.size() > 0)
    {
        ...
        while (!done)
        {
            ...
            {
                putText(renderer, "Life", font, text_space, clrWH, (player.Life > 0 && story->Type != Story::Type::DOOM) ? intLB : intRD, TTF_STYLE_NORMAL, splashw, infoh, startx, starty + text_bounds - (boxh + infoh));
                putText(renderer, (std::to_string(player.Life)).c_str(), font, text_space, clrBK, intBE, TTF_STYLE_NORMAL, splashw, boxh, startx, starty + text_bounds - boxh);
            }
                        ...
                        else if (story->Choices[current].Type == Choice::Type::ITEMS)
                        {
                            ...
                            else
                            {
                                ...
                                if (!loaded && weapons > 0)
                                {
                                    if (weapons > 1)
                                    {
                                        message = "The weapons you are carrying are not charged!";
                                    }
                                    else
                                    {
                                        message = "The weapon you are carrying is not charged!";
                                    }
                                }
                                else
                                {
    ...
    if (player.Skills.size() > limit)
    {
        ...
        while (!done)
        {
            ...
            if (!error)
            {
                ...
                putText(renderer, lose_message.c_str(), font, text_space, clrWH, intLB, TTF_STYLE_NORMAL, splashw, boxh, startx, starty);
            }
...
bool processStory(SDL_Window *window, SDL_Renderer *renderer, Character::Base &player, Story::Base *story)
{
    ...
    while (!quit)
    {
        ...
        auto vehicle_text = createText(vehicle_message.c_str(), FONT_FILE, font_size, clrWH, textwidth - 2 * text_space, TTF_STYLE_NORMAL);
        ...
        if (window && renderer)
        {
            ...
            while (!quit)
            {
                ...
                {
                    putText(renderer, "This adventure is over. You have failed.", font, text_space, clrWH, intRD, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
                ...
                {
                    putText(renderer, "This adventure is over. You have sacrificed your lives for the sake of the whole world.", font, text_space, clrWH, intDB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
                else if (story->Type == Story::Type::SENTINEL)
                {
                    putText(renderer, "This adventure is over. You have become an undying sentinel for all time.", font, text_space, clrWH, intDB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
                else if (story->Type == Story::Type::UNKNOWN)
                {
                    putText(renderer, "You have rejected the chance for power. This adventure is over now. You don't know how long you'll live. But then, who does?", font, text_space, clrWH, intDB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
                else if (story->Type == Story::Type::GODHOOD)
                {
                    putText(renderer, "You are immortal and all-powerful now. Your adventure has culminated in godhood.", font, text_space, clrWH, intDB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
                else if (story->Type == Story::Type::GOOD)
                {
                    putText(renderer, "You found the Heart of Volent and rejected the chance for power. Perhaps your destiny now is to save the world.", font, text_space, clrWH, intDB, TTF_STYLE_NORMAL, splashw, messageh, startx, starty);
                }
